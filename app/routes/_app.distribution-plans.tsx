  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage how your assets will be distributed to beneficiaries</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Distribution vehicles</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Age-based distributions</p>
          </CardContent>
        </Card>
      </div>
            ...
            {beneficiariesByTrust.map(({ trust, beneficiaries }) => (
              <div key={trust.id} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500">Created {new Date(trust.dateCreated).toLocaleDateString()}</span>
                </div>
                ...
                {beneficiaries.length > 0 ? (
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {beneficiaries.map((beneficiary, index) => (
                        <div key={`beneficiary-${index}`} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <div>
                            <p className="font-medium text-gray-900">{beneficiary.name}</p>
                            <p className="text-sm text-gray-600">{beneficiary.relationship}</p>
                          </div>
                          <div className="text-right">
                            <p className="font-medium text-gray-900">{beneficiary.percentage}%</p>
                            {beneficiary.conditions && (
                              <p className="text-xs text-gray-600">{beneficiary.conditions}</p>
                            )}
                          </div>
                        </div>
                      ))}
                  ...
                  <p className="text-sm text-gray-600 italic">No beneficiaries assigned yet</p>
                )}
              </div>
            ))}
          </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Age-Based Distributions</h4>
                <p className="text-sm text-gray-600">Children receive $300,000 at age 25, with full control at age 35</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
              <div>
                <h4 className="font-medium text-gray-900">Guardian Provisions</h4>
                <p className="text-sm text-gray-600">Yvonne Westfall named as primary guardian for minor children</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">If no surviving heirs, assets distributed to Hanzlik family members</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Surviving spouse serves as trustee, followed by Arvest Bank</p>
              </div>
            </div>
          </div>
        </CardContent>
