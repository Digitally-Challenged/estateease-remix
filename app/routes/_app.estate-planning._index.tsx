  ...
  if (error) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Estate Planning Center</h1>
          <p className="text-gray-600 mt-2">Complete estate planning overview and progress tracking</p>
        </div>
        <ErrorDisplay
          error={error}
          type="server"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Across all assets</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Trust structures</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">
              {hasValidBeneficiaries ? (
                ...
                <span className="text-orange-600">{totalBeneficiaryPercentage}% allocated</span>
              )}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-1">Assigned roles</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-4">
            {trusts.length > 0 ? (
              ...
              <div className="text-center py-4">
                <p className="text-gray-600 mb-4">No trusts created yet</p>
                <Button asChild>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {beneficiaries.length > 0 ? (
              ...
              <div className="text-center py-4">
                <p className="text-gray-600 mb-4">No beneficiaries assigned yet</p>
                <Button asChild>
