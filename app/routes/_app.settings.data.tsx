  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Import, export, and manage your estate planning data</p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">Active Trusts</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">Automatic Backup</p>
                  <p className="text-sm text-gray-600">2 days ago at 3:00 AM</p>
                </div>
              </div>
              <Badge variant="secondary">Completed</Badge>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">Deleted Records</span>
