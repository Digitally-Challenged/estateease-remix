  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500 mt-2">Manage your power of attorney documents and designated agents</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            <User className="h-5 w-5 text-gray-600 dark:text-gray-400 dark:text-gray-500 mr-2" />
        ...
        <CardContent>
          {poaRoles.length > 0 ? (
            <div className="space-y-4">
              {poaRoles.map((role) => (
                <div key={role.id} className="flex items-start justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <div>
                    <div className="flex items-center space-x-2">
                      <h3 className="font-medium text-gray-900 dark:text-gray-100">{role.personName}</h3>
            ...
            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500">No power of attorney agents currently assigned</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            <FileText className="h-5 w-5 text-gray-600 dark:text-gray-400 dark:text-gray-500 mr-2" />
              ...
              <div key={doc.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 mt-1">{doc.description}</p>
                    <div className="flex items-center space-x-4 mt-3 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900 dark:text-gray-100">Durable vs. Non-Durable</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Durable POAs remain effective if you become incapacitated, while non-durable POAs terminate upon incapacity</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Some POAs only become effective upon certain conditions, such as medical incapacity</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Review and update your POA documents every 3-5 years or after major life changes</p>
              </div>
            </div>
          </div>
        </CardContent>
