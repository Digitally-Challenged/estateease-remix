  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900">AI Estate Planning Advisor</h1>
        <p className="text-gray-600 mt-2">Get personalized guidance for your estate planning questions</p>
      </div>
      ...
      <Card className="bg-gray-50 border-gray-200">
        <CardContent className="text-center py-8">
          ...
          <h3 className="text-lg font-medium text-gray-900">AI Advisor Coming Soon!</h3>
