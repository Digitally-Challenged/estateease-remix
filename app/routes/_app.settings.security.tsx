        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-600">Today at 9:15 AM</span>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="font-medium text-gray-900">MacBook Pro - Chrome</h4>
                  <p className="text-sm text-gray-600">Portland, OR • 192.168.1.1</p>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="font-medium text-gray-900">iPhone 14 Pro - Safari</h4>
                  <p className="text-sm text-gray-600">Portland, OR • Mobile Network</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="share-with-spouse" className="font-medium text-gray-900">
                  Share with Spouse
                </label>
                <p className="text-sm text-gray-600">
            ...
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="share-with-advisors" className="font-medium text-gray-900">
                  Share with Advisors
                </label>
                <p className="text-sm text-gray-600">
            ...
            <div className="flex items-center justify-between">
              <div>
                <label htmlFor="require-approval" className="font-medium text-gray-900">
