...
export default function EditTrust() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Edit Trust</h1>
        <p className="text-gray-600">Update the trust information and settings</p>
      </div>
      ...
      {actionData?.error && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
          ...
          {actionData.fieldErrors && Object.keys(actionData.fieldErrors).length > 0 && (
            <div className="mt-3">
              <div className="text-red-700 font-medium text-sm">Validation Errors:</div>
