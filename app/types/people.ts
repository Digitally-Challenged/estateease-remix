...
export interface LegalRole {
  id: string;
  roleType: 'executor' | 'trustee' | 'successor_trustee' | 'power_of_attorney' | 'guardian' | 'healthcare_proxy';
  personId: string;
  personName: string;
  isPrimary: boolean;
...
export interface Professional {
  id: string;
  name: string;
  type: 'estate_attorney' | 'tax_attorney' | 'financial_advisor' | 'accountant' | 'insurance_agent' | 'other';
  firm?: string;
  title?: string;
